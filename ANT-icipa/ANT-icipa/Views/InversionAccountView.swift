...
struct InversionAccountView: View {
    ...
    let accounts = [
        BankAccount(accountNumber: "Hormiguero 360 Performance", iconColor: .green, isSystemImage: true),
        BankAccount(accountNumber: "Fondo CD - 1 año", iconColor: .black, isSystemImage: true)
    ]
        ...
        VStack(spacing: 0) {
            ...
            .clipShape(BottomRoundedShape(radius: 25)) // Only round bottom corners
                ...
                VStack(alignment: .leading, spacing: 24) {
                    ...
                    // MARK: - DESCRIPCIÓN
                    Text("Selecciona la cuenta donde\niran tus fondos")
                        .font(.system(size: 17))
...
// MARK: - FILA DE CUENTA
struct InversionAccountRow: View {
    let account: InversionAccountView.BankAccount
    let isSelected: Bool
    let action: () -> Void
